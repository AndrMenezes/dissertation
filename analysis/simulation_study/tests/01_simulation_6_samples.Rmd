---
title: "Testando simulação com 6 indíviduos"
...
parms_6_samples <- readRDS("../data/parms_6_samples.rds")
```
# Parâmetros
...
simul_de <- simulate_sce(estimated_parameters = parms_6_samples, 
                         n_genes = 1000, n_group = 2, pct_de = 0.4,
                         var_effect = 0.1, fc = 6, range_n_cells = c(200, 500))
...
simul_not_de_3 <- simulate_sce(estimated_parameters = parms_6_samples, 
                               n_genes = 1000, n_group = 3, var_effect = 0.1,
                               range_n_cells = c(200, 500))
...
simul_de_3 <- simulate_sce(estimated_parameters = parms_6_samples, 
                           ...
                           pct_de = 0.4, fc = 6, var_effect = 0.1,
                           range_n_cells = c(200, 500))
