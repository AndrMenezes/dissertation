...
set.seed(6969)
simul_not_de <- simulate_sce(estimated_parameters = parms_6_samples, 
                             n_genes = 1000, n_group = 2, var_effect = 0.1,
...
set.seed(6969)
simul_de <- simulate_sce(estimated_parameters = parms_6_samples, 
                         n_genes = 1000, n_group = 2, n_de = 400, 
                         fc = 6, range_n_cells = c(200, 500))
...
set.seed(6969)
simul_not_de_3 <- simulate_sce(estimated_parameters = parms_6_samples, 
...
set.seed(6969)
simul_de_3 <- simulate_sce(estimated_parameters = parms_6_samples, 
                           n_genes = 1000, n_group = 3,
                           n_de = 400, fc = 6,
                           range_n_cells = c(200, 500))
...
set.seed(6969)
simul_not_de_4 <- simulate_sce(estimated_parameters = parms_6_samples, 
...
set.seed(6969)
simul_de_4 <- simulate_sce(estimated_parameters = parms_6_samples, 
                           n_genes = 1000, n_group = 4, 
                           n_de = 400, fc = 6,
                           range_n_cells = c(200, 500))
...
# 2 grupos
saveRDS(sce_not_de, file.path(path, "test_samples_6_groups_2_nde.rds"))
saveRDS(sce_de, file.path(path, "test_samples_6_groups_2_de"))
# 3 grupos
saveRDS(sce_not_de_3, file.path(path, "test_samples_6_groups_3_nde.rds"))
saveRDS(sce_de_3, file.path(path, "test_samples_6_groups_3_de.rds"))
# 4 grupos
saveRDS(sce_not_de_4, file.path(path, "test_samples_6_groups_4_nde.rds"))
saveRDS(sce_de_4, file.path(path, "test_samples_6_groups_4_de.rds"))
